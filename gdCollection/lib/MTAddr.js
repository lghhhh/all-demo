...
const _require = require('./DAO/SQLiteDAO_MT_Addr')
const SearchParamModel = _require.SearchParamModel
const AddressModel = _require.AddressModel

const api = require('./util/apiMT')

const common = require('./util/common') // ==========================↓↓↓ 数据库操作--数据采集条件获取 ↓↓↓================================
...
function _getAddressInsertData () {
  _getAddressInsertData = _asyncToGenerator(/* #__PURE__ */regeneratorRuntime.mark(function _callee4 (CityCode, Keyword, originalParams, data) {
    let _data$result, _geocodes$entity, _geocodes$entity2, _geocodes$entity3, _geocodes$entity4, _geocodes$entity5

    let geocodes, saveData
...
function _main () {
  _main = _asyncToGenerator(/* #__PURE__ */regeneratorRuntime.mark(function _callee9 () {
    let result, waitingRows, waitingRowsLen, insertDatas, batchId, i, id, cityCode, keyWord, originalParams, data
